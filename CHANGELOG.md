...
- Update performance benchmarks with latest stress test results

### Features

- *(notify)* Runtime-agnostic write notifications

## [0.4.1] - 2025-12-16

### Documentation

- Update README to match current codebase and API
- Update website documentation and README links

## [0.4.0] - 2025-12-16

### Features

- Add optional serde support for VarveConfig serialization
